    ...
    <section>
      ...
      <div class="card" style="margin-top:18px">
        ...
        <div id="faqList">
          ...
          <button class="accordion">Does it need a build?</button><div class="panel"><p>No build. Serve the root or open index.html for basic use.</p><pre>python3 -m http.server 8000</pre></div>
